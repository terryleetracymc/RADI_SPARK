...
public class PGenerateTSDebug extends BaseApp implements sparkOperation {
	...
	public static void main(String args[]) {
		...
		PGenerateTSDebug ts = new PGenerateTSDebug();
	...
	public JavaRDDLike operate(JavaRDDLike input, String args[]) {
		 ...
		 */
					...
					public Tuple2<String, Iterable<GeoTSShortVector>> call(
						...
						GeoShortChunk datas[] = new GeoShortChunk[3];
